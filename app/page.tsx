    ...
    <>
      ...
      <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl">
          <p className="text-[#22d3ee] text-xs tracking-[0.3em] uppercase mb-6">
          ...
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl font-black leading-[1.05] tracking-tight mb-8">
            Authority
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#22d3ee] to-[#0891b2]">
              Engineered
            </span>
            <br />
            in Code
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/work"
              className="group inline-flex items-center gap-2 px-6 py-3 bg-[#22d3ee] text-black text-sm font-semibold tracking-[0.1em] uppercase transition-all hover:bg-[#0891b2]"
            >
              View Proof
            ...
            <Link
              href="/#contact"
              className="inline-flex items-center gap-2 px-6 py-3 border border-[#1f1f1f] text-[#a0a0a0] text-sm font-semibold tracking-[0.1em] uppercase transition-all hover:border-[#22d3ee] hover:text-[#22d3ee]"
            >
              Engage
            </Link>
          </div>
        ...
        {/* Accent line */}
        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#22d3ee] to-transparent opacity-30" />
      </section>

      {/* Index */}
      <section className="px-6 md:px-12 py-32 border-t border-[#1f1f1f]">
        <p className="text-[#22d3ee] text-xs tracking-[0.3em] uppercase mb-16">
          Navigate
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-[#1f1f1f]">
          {SECTIONS.map(({ icon: Icon, label, href, description }) => (
            ...
            >
              <Icon
                size={20}
                className="text-[#22d3ee] group-hover:scale-110 transition-transform"
              />
              <div>
              ...
              <ArrowRight
                size={14}
                className="text-[#22d3ee] opacity-0 group-hover:opacity-100 transition-opacity mt-auto"
              />
            </Link>
          ))}
        </div>
      ...
      >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-8 py-4 bg-[#22d3ee] text-black text-sm font-semibold tracking-[0.1em] uppercase hover:bg-[#0891b2] transition-colors shrink-0"
        >
