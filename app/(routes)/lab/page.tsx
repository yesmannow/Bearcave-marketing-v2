...
const LAB_ITEMS = [
  ...
  },
  {
    ...
    status: "Production",
    category: "AI / ML",
    tags: ["TensorFlow", "Python", "Lead Scoring"],
    summary: "TensorFlow-powered lead scoring engine with model training visualization — surfaces high-intent prospects in real time.",
  },
  {
    id: "clinical-compass",
    ...
    tags: ["TensorFlow", "Kubernetes", "Datadog"],
    summary: "Anomaly scoring model that predicts and auto-resolves infrastructure degradation — 94% resolution rate before alerts fire.",
  },
  {
    ...
    tags: ["Cloudflare WAF", "DNSSEC", "Zero-Trust"],
    summary: "Real-time WAF telemetry pipeline blocking 85k+ malicious threats monthly — the engine behind The Fortress case study.",
  },
  {
    id: "lcp-optimizer",
    name: "LCP Optimizer",
