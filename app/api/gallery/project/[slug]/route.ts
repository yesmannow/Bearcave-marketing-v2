...
const PROJECT_MANIFESTS: Record<string, ProjectManifest> = {
  ...
  '317bbq': {
    ...
    // Cloudinary folder: studio/proof/317bbq
    hero: [
      // Hero photography (normalize unstructured filenames into predictable buckets)
      'dsc_8684',
      'gc_photography_317-81_1',
      'image_from_ios',
      'image252bios2525281_252529',
      'img_1964',
      '130230087_',
      '310751236_',
      '315628638_',
    ...
    branding: [
      // Anchor logo + known logo variants
      '317-bbq-logo-anchor',
      'logo-11',
      '317bbq+logo-11',
      '317bbq_logo-11',
      '317bbq_logo-11_mg50a9',
      '317-bbq-logo',
      '317-bbq-logo_lcuh6w',
      '317bbq_logo',
      '317_bbq_logo',
  ...
  'hoosierboy-barber-shop': {
    ...
    accent: '#B22222',
    hero: [
      'barbershop-4484297_1920',
      'barbershop-4484297',
      'barber-1017457_1920',
      'barber-1017457',
    ],
    branding: [
      'hoosierboy-logo-anchor',
      'hoosierboy-barber-shop-logo',
      'hoosierboy_barbershop_logo_1',
      'bcard_google2',
      'bcard_google',
      'hoosierboy-bcard',
    ],
